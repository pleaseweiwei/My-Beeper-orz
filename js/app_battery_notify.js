    ...
    if (!banner) {
        ...
        banner.innerHTML = `
            ...
            <div style="flex: 1; display: flex; flex-direction: column; gap: 4px; overflow: hidden;">
                <span id="btn-banner-name" style="font-size: 13px; font-weight: 600; color: #333; line-height: 1;"></span>
                <span id="btn-banner-text" style="font-size: 12px; color: #666; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;"></span>
            </div>
        `;
