...
function _appendCallMsg(text, role, avatarSrc) {
    ...
    segs.forEach(seg => {
        ...
        if (seg.type === 'action') {
            ...
            el.innerHTML = `<i class="fas fa-asterisk" style="font-size:8px;opacity:0.5;"></i> ${seg.text}`;
        } else {
...
<div class="vc-calling-overlay">
  ...
  <div style="margin-top:30px;font-size:11px;color:rgba(255,255,255,0.3);">对方现在无法接听</div>
</div>`;
