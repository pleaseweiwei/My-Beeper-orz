...
;(function () {
    ...
    var longPressTimer = null, touchStartPos = null, LONG_PRESS_DURATION = 500, MOVE_THRESHOLD = 10, isLongPressTriggered = false, suppressNextClick = false;
    ...
    function onPointerUp(e) {
        ...
        if (isLongPressTriggered) { suppressNextClick = true; isLongPressTriggered = false; e.preventDefault(); e.stopPropagation(); }
        touchStartPos = null;
    }
...
function toggleOpacityControls(item) {
        ...
        controls.innerHTML = '<div class="tw-ctrl-btn tw-color-toggle ' + btnClass + '" style="margin-right:8px;"><i class="fas fa-adjust"></i></div>' +
                             '<div class="tw-ctrl-btn tw-opacity-toggle" style="background:#f0f0f0; color:#333; padding:4px 8px; border-radius:12px; font-size: calc(12px * var(--font-scale)); cursor:pointer; user-select:none;">' + Math.round(opacity * 100) + '%</div>';
...
window.createCustomWidget = function() {
    ...
    document.getElementById('custom-widget-preview').innerHTML = '<i class="fas fa-image" style="color:#ccc; font-size: calc(24px * var(--font-scale));"></i>';
...
window.addWidget = function(type, sizeClass) {
    ...
    if (type === 'unified-header') {
        ...
        el.innerHTML = '<div class="music-info"><div style="font-size: calc(9px * var(--font-scale)); color:#aaa; margin-bottom:5px; letter-spacing:1px;">NOW PLAYING</div><div class="music-title" id="home-music-title" contenteditable="true" onclick="event.stopPropagation()" onblur="saveHomeMusicText()">Lover</div><div class="music-artist" id="home-music-artist" contenteditable="true" onclick="event.stopPropagation()" onblur="saveHomeMusicText()">Taylor Swift</div><div class="wave-box"><div class="wave"></div><div class="wave"></div><div class="wave"></div><div class="wave"></div></div></div><div class="vinyl-record"><div class="vinyl-inner" data-edit-key="music" onclick="event.stopPropagation(); triggerChangeImage(this, \'bg\')"></div></div>';
        ...
        el.style.transform = 'scale(0.95)';
        el.style.transformOrigin = 'top center';
        el.innerHTML = '<div class="receipt-hole"></div><div class="receipt-header"><div class="receipt-title">RECEIPT</div><div class="receipt-date">NO.2026-02-22</div></div><div class="receipt-divider-dashed"></div><div class="receipt-list"><div class="receipt-item" onclick="openSimulatedApp(\'taobao\')"><div class="r-item-name"><span class="r-qty">01</span><span>SHOPPING (Taobao)</span></div><div class="r-item-price">OPEN <i class="fas fa-chevron-right" style="font-size: calc(8px * var(--font-scale));"></i></div></div><div class="receipt-item" onclick="openSimulatedApp(\'meituan\')"><div class="r-item-name"><span class="r-qty">02</span><span>DELIVERY (Meituan)</span></div><div class="r-item-price">OPEN <i class="fas fa-chevron-right" style="font-size: calc(8px * var(--font-scale));"></i></div></div></div><div class="receipt-divider-line"></div><div class="receipt-footer"><div class="receipt-total"><span>TOTAL</span><span style="font-weight:700;">¥ 999.00</span></div><div class="receipt-barcode">||| || ||| | |||| || || | |||| |||</div></div>';
    } else if (type === 'k-dday') {
