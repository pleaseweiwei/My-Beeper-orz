        ...
        if (style === 'emoji') {
            ...
            if (style === 'live2d') {
                ...
                if (live2dSrc) {
                    ...
                    ifr.srcdoc = '<html><body style="margin:0;background:transparent;display:flex;justify-content:center;align-items:center;height:100%;font-size: calc(40px * var(--font-scale));">🐱</body></html>';
                }
            } else {
