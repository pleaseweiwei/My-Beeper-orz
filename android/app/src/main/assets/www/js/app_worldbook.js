...
function renderShelf(filterText = '') {
    ...
    worldBooks.forEach(book => {
        ...
        card.innerHTML = `
            ...
            ${book.global ? '<i class="fas fa-globe" style="position:absolute; top:10px; right:10px; font-size: calc(12px * var(--font-scale)); color:#ddd;"></i>' : ''}
        `;
...
function renderEntriesList() {
    ...
    tempEntries.forEach((entry, index) => {
        ...
        item.innerHTML = `
            ...
            <div style="font-size: calc(12px * var(--font-scale)); color:${entry.enabled ? '#07c160' : '#ccc'};">
